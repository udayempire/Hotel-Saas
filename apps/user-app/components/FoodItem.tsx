...
export const FoodItem = ({ name }: foodItemProps) => {
    return (
        <div>
            <div className="relative">
                ...
                <div className="px-2 left-2 right-2 absolute bottom-2 z-10">
                    <div className="flex justify-between  items-center">
                        <p className="text-white ">Rs 99</p>
                        <Cart />
                    </div>
                </div>
                {/* Food image */}
                <Image src={"/foodType2.png"} width={200} height={200} alt="" className="rounded-md" />
            </div>
